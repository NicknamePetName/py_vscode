...
def getCustomerData(customer,user_data,pet_data,card_data):
    ...
    try:
       customerInfoResponse1 = requests.get(URL_1, timeout=30, headers=headers)
    except Exception:
        try:
            customerInfoResponse1 = requests.get(URL_1, timeout=30, headers=headers)
        except Exception:
    ...
    try:
       customerInfoResponse3 = requests.get(URL_3, timeout=30, headers=headers)
    except Exception:
        try:
            customerInfoResponse3 = requests.get(URL_3, timeout=30, headers=headers)
        except Exception:
    ...
    try:
       customerInfoResponse4 = requests.get(URL_4, timeout=30, headers=headers)
    except Exception:
        try:
            customerInfoResponse4 = requests.get(URL_4, timeout=30, headers=headers)
        except Exception:
...
def getExpenseCalendarData(customer):
    ...
    response = ''
    try:
       response = requests.post(URL_ex_ca_all,data=json.dumps(data), timeout=30, headers=headers)
    except Exception:
        try:
            response = requests.post(URL_ex_ca_all,data=json.dumps(data), timeout=30, headers=headers)
        except Exception:
    ...
    for order in responseData:
        ...
        if int(order['id']) == 0:
            try:
                orderDetailResponse = requests.post(URL_order_detail, data=json.dumps(dataorderDetail_0),  timeout=30, headers=headers)
            except Exception:
                try:
                    orderDetailResponse = requests.post(URL_order_detail, data=json.dumps(dataorderDetail_0),  timeout=30, headers=headers)
                except Exception:
            ...
            try:
                orderDetailResponse = requests.post(URL_order_detail, data=json.dumps(dataorderDetail_1),  timeout=30, headers=headers)
            except Exception:
                try:
                    orderDetailResponse = requests.post(URL_order_detail, data=json.dumps(dataorderDetail_1),  timeout=30, headers=headers)
                except Exception:
...
def getProductData(product_data,product_catalog_data):
    ...
    try:
        product_detail_other1_response = requests.get(product_detail_other1, timeout=30, headers=headers)
        product_detail_other2_response = requests.get(product_detail_other2, timeout=30, headers=headers)
        product_detail_other3_response = requests.get(product_detail_other3, timeout=30, headers=headers)
    except Exception:
        try:
            product_detail_other1_response = requests.get(product_detail_other1, timeout=30, headers=headers)
            product_detail_other2_response = requests.get(product_detail_other2, timeout=30, headers=headers)
    ...
    for i in range(1,14):
        ...
        response = ''
        try:
            response = requests.get(URL_product_catalog, timeout=30, headers=headers)
        except Exception:
            try:
                response = requests.get(URL_product_catalog, timeout=30, headers=headers)
            except Exception:
        ...
        for responseData in responseListData:
            ...
            productResponse = ''
            try:
                productResponse = requests.post(URL_product_detail,data=json.dumps(data), timeout=30, headers=headers)
            except Exception:
                try:
                    productResponse = requests.post(URL_product_detail,data=json.dumps(data), timeout=30, headers=headers)
                except Exception:
        ...
        responseListAll = ''
        try:
            responseListAll = requests.post(URL_product_detail,data=data_all_str, timeout=30, headers=headers_text)
        except Exception:
            try:
                responseListAll = requests.post(URL_product_detail,data=data_all_str, timeout=30, headers=headers_text)
            except Exception:
        ...
        for product in responseListAllData:
            ...
            try:
                product_detail_response = requests.get(URL_product_detail_other, timeout=30, headers=headers)
            except Exception:
                try:
                    product_detail_response = requests.get(URL_product_detail_other, timeout=30, headers=headers)
                except Exception:
...
def getVaccineData(customer,vaccine_data,vaccine_detail_data):
    ...
    customer_response = ''
    try:
        customer_response = requests.get(URL_customer, timeout=30, headers=headers)
    except Exception:
        try:
            customer_response = requests.get(URL_customer, timeout=30, headers=headers)
        except Exception:
    ...
    vaccine_response = ''
    try:
        vaccine_response = requests.post(URL_Vaccine,data=json.dumps(data), timeout=30, headers=headers)
    except Exception:
        try:
            vaccine_response = requests.post(URL_Vaccine,data=json.dumps(data), timeout=30, headers=headers)
        except Exception:
    ...
    pets_response = ''
    try:
        pets_response = requests.get(URL_pets, timeout=30, headers=headers)
    except Exception:
        try:
            pets_response = requests.get(URL_pets, timeout=30, headers=headers)
        except Exception:
    ...
    for pet in petsResponseData:
        ...
        clinic_pet_response = ''
        try:
            clinic_pet_response = requests.get(URL_clinic_pet, timeout=30, headers=headers)
        except Exception:
            try:
                clinic_pet_response = requests.get(URL_clinic_pet, timeout=30, headers=headers)
            except Exception:
        ...
        try:
            protections_response = requests.get(URL_protections, timeout=30, headers=headers)
        except Exception:
            try:
                protections_response = requests.get(URL_protections, timeout=30, headers=headers)
            except Exception:
        ...
        for protection in protectionsResponseListData: 
            ...
            protection_response = ''
            try:
                protection_response = requests.get(URL_protection, timeout=30, headers=headers)
            except Exception:
                try:
                    protection_response = requests.get(URL_protection, timeout=30, headers=headers)
                except Exception:
        ...
        insects_response = ''
        try:
            insects_response = requests.get(URL_insects, timeout=30, headers=headers)
        except Exception:
            try:
                insects_response = requests.get(URL_insects, timeout=30, headers=headers)
            except Exception:
        ...
        for insect in insectsResponseListData:
            ...
            insect_response = ''
            try:
                insect_response = requests.get(URL_insect, timeout=30, headers=headers)
            except Exception:
                try:
                    insect_response = requests.get(URL_insect, timeout=30, headers=headers)
                except Exception:
...
def getCasesData(customer,cases_data):
    ...
    try:
        medical_record_response = requests.post(URL_medical_record,data=json.dumps(data), timeout=30, headers=headers)
        hospitalization_record_response = requests.post(URL_hospitalization_record,data=json.dumps(data), timeout=30, headers=headers)
    except Exception:
        try:
            medical_record_response = requests.post(URL_medical_record,data=json.dumps(data), timeout=30, headers=headers)
            hospitalization_record_response = requests.post(URL_hospitalization_record,data=json.dumps(data), timeout=30, headers=headers)
    ...
    abstracts_response = ''
    try:
        medical_record_version_response = requests.get(URL_medical_record_version, timeout=30, headers=headers)
        diagnosis_response = requests.get(URL_diagnosis, timeout=30, headers=headers)
        usage_response = requests.get(URL_usage, timeout=30, headers=headers)
        abstracts_response = requests.get(URL_abstracts, timeout=30, headers=headers)
    except Exception:
        try:
            medical_record_version_response = requests.get(URL_medical_record_version, timeout=30, headers=headers)
            diagnosis_response = requests.get(URL_diagnosis, timeout=30, headers=headers)
    ...
    for medicalRecordData in medicalRecordResponseData:
        ...
        try:
            cases_head_response = requests.get(URL_cases_head, timeout=30, headers=headers)
            cases_nav_response = requests.get(URL_cases_nav, timeout=30, headers=headers)
            return_visit_list_response = requests.get(URL_return_visit_list, timeout=30, headers=headers)
    ...
    for hospitalizationRecordData in hospitalizationRecordResponseData:
        ...
        try:
            hospitalization_head_response = requests.get(URL_hospitalization_head, timeout=30, headers=headers)
            hospitalization_nav_response = requests.get(URL_hospitalization_nav, timeout=30, headers=headers)
            hospitalization_table_head_response = requests.get(URL_hospitalization_table_head, timeout=30, headers=headers)
        except Exception:
            try:
                hospitalization_head_response = requests.get(URL_hospitalization_head, timeout=30, headers=headers)
                hospitalization_nav_response = requests.get(URL_hospitalization_nav, timeout=30, headers=headers)
        ...
        for hospitalizationNavData in hospitalizationNavResponseData:
            for clinic in hospitalizationNavData['clinics']:
                ...
                try:
                    hospitalization_time_response = requests.get(URL_hospitalization_time, timeout=30, headers=headers)
                    hospitalization_return_visit_list_response = requests.get(URL_hospitalization_return_visit_list, timeout=30, headers=headers)
