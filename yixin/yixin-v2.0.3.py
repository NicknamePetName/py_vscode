...
try:
    ...
    response = requests.get(URL_all, timeout=5, headers=headers)  
...
def getCustomerData(customer,user_data,pet_data,card_data):
    ...
    while retries < max_retries:
        try:
            customerInfoResponse2 = requests.get(URL_2, timeout=5, headers=headers)
    ...
    while retries < max_retries:
        try:
            customerInfoResponse1 = requests.get(URL_1, timeout=5, headers=headers)
    ...
    while retries < max_retries:
        try:
            customerInfoResponse3 = requests.get(URL_3, timeout=5, headers=headers)
    ...
    while retries < max_retries:
        try:
            customerInfoResponse4 = requests.get(URL_4, timeout=5, headers=headers)
...
def getExpenseCalendarData(customer):
    ...
    while retries < max_retries:
        try:
            response = requests.post(URL_ex_ca_all,data=json.dumps(data), timeout=5, headers=headers)
    ...
    for order in responseData:
        ...
        if int(order['id']) == 0:
            ...
            while retries < max_retries:
                try:
                    orderDetailResponse = requests.post(URL_order_detail, data=json.dumps(dataorderDetail_0),  timeout=5, headers=headers)
            ...
            while retries < max_retries:
                try:
                    orderDetailResponse = requests.post(URL_order_detail, data=json.dumps(dataorderDetail_1),  timeout=5, headers=headers)
                    if int(json.loads(orderDetailResponse.text)['Code']) != 0:
                        raise Exception("请求失败，返回码非0")
                    break  # 请求成功，退出循环
                except Exception as e:
...
def getProductData(product_data,product_catalog_data):
    ...
    while retries < max_retries:
        try:
            product_detail_other1_response = requests.get(product_detail_other1, timeout=5, headers=headers)
    ...
    while retries < max_retries:
        try:
            product_detail_other2_response = requests.get(product_detail_other2, timeout=5, headers=headers)
    ...
    while retries < max_retries:
        try:
            product_detail_other3_response = requests.get(product_detail_other3, timeout=5, headers=headers)
    ...
    for i in range(1,14):
        ...
        while retries < max_retries:
            try:
                response = requests.get(URL_product_catalog, timeout=5, headers=headers)
                if int(json.loads(response.text)['Code']) != 0:
                    raise Exception("请求失败，返回码非0")
                break  # 请求成功，退出循环
            except Exception as e:
        ...
        for responseData in responseListData:
            ...
            while retries < max_retries:
                try:
                    productResponse = requests.post(URL_product_detail,data=json.dumps(data), timeout=5, headers=headers)
        ...
        while retries < max_retries:
            try:
                responseListAll = requests.post(URL_product_detail,data=data_all_str, timeout=5, headers=headers_text)
        ...
        for product in responseListAllData:
            ...
            while retries < max_retries:
                try:
                    product_detail_response = requests.get(URL_product_detail_other, timeout=5, headers=headers)
...
def getVaccineData(customer,vaccine_data,vaccine_detail_data):
    ...
    while retries < max_retries:
        try:
            customer_response = requests.get(URL_customer, timeout=5, headers=headers)
    ...
    while retries < max_retries:
        try:
            vaccine_response = requests.post(URL_Vaccine,data=json.dumps(data), timeout=5, headers=headers)
    ...
    while retries < max_retries:
        try:
            pets_response = requests.get(URL_pets, timeout=5, headers=headers)
    ...
    for pet in petsResponseData:
        ...
        while retries < max_retries:
            try:
                clinic_pet_response = requests.get(URL_clinic_pet, timeout=5, headers=headers)
        ...
        while retries < max_retries:
            try:
                protections_response = requests.get(URL_protections, timeout=5, headers=headers)
        ...
        for protection in protectionsResponseListData: 
            ...
            while retries < max_retries:
                try:
                    protection_response = requests.get(URL_protection, timeout=5, headers=headers)
        ...
        while retries < max_retries:
            try:
                insects_response = requests.get(URL_insects, timeout=5, headers=headers)
        ...
        for insect in insectsResponseListData:
            ...
            while retries < max_retries:
                try:
                    insect_response = requests.get(URL_insect, timeout=5, headers=headers)
...
def getCasesData(customer,cases_data):
    ...
    while retries < max_retries:
        try:
            medical_record_response = requests.post(URL_medical_record,data=json.dumps(data), timeout=5, headers=headers)
    ...
    while retries < max_retries:
        try:
            hospitalization_record_response = requests.post(URL_hospitalization_record,data=json.dumps(data), timeout=5, headers=headers)
    ...
    while retries < max_retries:
        try:
            medical_record_version_response = requests.get(URL_medical_record_version, timeout=5, headers=headers)
    ...
    while retries < max_retries:
        try:
            diagnosis_response = requests.get(URL_diagnosis, timeout=5, headers=headers)
    ...
    while retries < max_retries:
        try:
            usage_response = requests.get(URL_usage, timeout=5, headers=headers)
    ...
    while retries < max_retries:
        try:
            abstracts_response = requests.get(URL_abstracts, timeout=5, headers=headers)
    ...
    for medicalRecordData in medicalRecordResponseData:
        ...
        while retries < max_retries:
            try:
                cases_head_response = requests.get(URL_cases_head, timeout=5, headers=headers)
        ...
        while retries < max_retries:
            try:
                cases_nav_response = requests.get(URL_cases_nav, timeout=5, headers=headers)
        ...
        while retries < max_retries:
            try:
                return_visit_list_response = requests.get(URL_return_visit_list, timeout=5, headers=headers)
        ...
        while retries < max_retries:
            try:
                cases_detail_response = requests.get(URL_cases_detail, timeout=5, headers=headers)
    ...
    for hospitalizationRecordData in hospitalizationRecordResponseData:
        ...
        while retries < max_retries:
            try:
                hospitalization_head_response = requests.get(URL_hospitalization_head, timeout=5, headers=headers)
        ...
        while retries < max_retries:
            try:
                hospitalization_nav_response = requests.get(URL_hospitalization_nav, timeout=5, headers=headers)
        ...
        while retries < max_retries:
            try:
                hospitalization_table_head_response = requests.get(URL_hospitalization_table_head, timeout=5, headers=headers)
        ...
        for hospitalizationNavData in hospitalizationNavResponseData:
            for clinic in hospitalizationNavData['clinics']:
                ...
                while retries < max_retries:
                    try:
                        hospitalization_time_response = requests.get(URL_hospitalization_time, timeout=5, headers=headers)
                ...
                while retries < max_retries:
                    try:
                        hospitalization_return_visit_list_response = requests.get(URL_hospitalization_return_visit_list, timeout=5, headers=headers)
                ...
                while retries < max_retries:
                    try:
                        hospitalization_detail_response = requests.get(URL_hospitalization_detail, timeout=5, headers=headers)
